 ...
 * GregorianJulian. To construct a Chronology you should use the factory methods
 * on the chronology subclass in the chrono package.
 * <p>
 ...
 * <ul>
 * <li>ISO - The <i>de facto<i> world calendar system, based on the ISO-8601
 * standard
 ...
 * It does not 'strongly' define these fields however, thus implementations are
 * free to interpret the field names as they wish. For example, a week could be
 * defined as 10 days and a month as 40 days in a special WeirdChronology
 * implementation. Clearly the GJ and ISO implementations provided use the field
...
public abstract class Chronology {
	 ...
	 * zone. Chronologies that do not operate in a time zone or are already UTC
	 ...
	 * month, day, and millisecond values. The set of given values must refer to
	 * a valid datetime, or else an IllegalArgumentException is thrown.
	 * <p>
	...
	// @ requires millisOfDay > 0 && millisOfDay <= 24 * 60 * 60 * 1000;
	...
	public abstract long getDateTimeMillis(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour,
	...
	// @ requires secondOfMinute >= 0 && secondOfMinute <= 60;
	// @ requires millisOfSecond >= 0 && millisOfSecond <= 1000;
	public abstract long getDateTimeMillis(long instant, int hourOfDay, int minuteOfHour, int secondOfMinute,
			int millisOfSecond);

	// -----------------------------------------------------------------------
	/**
	 * Validates whether the values are valid for the fields of a partial
	 * instant.
	 *
	 * @param partial
	 ...
	 */
	public abstract void validate(ReadablePartial partial, /* @ non null @ */ int[] values);

	/**
	 * Gets the values of a partial from an instant.
	 *
	 * @param partial
	 *            the partial instant to use
	 * @param instant
	 ...
	 *
	 * <p>
	 * DayOfWeek values are defined in {@link DateTimeConstants}. They use the
	 * ISO definitions, where 1 is Monday and 7 is Sunday.
	 * 
	 * @return DateTimeField or UnsupportedDateTimeField if unsupported
	 */
