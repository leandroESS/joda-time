...
/**
 * YearMonthDay is an immutable partial supporting the year, monthOfYear and
 * dayOfMonth fields.
 * <p>
 * NOTE: This class only supports the three fields listed above. Thus, you
 * cannot query the dayOfWeek or centuryOfEra fields for example. The new
 * <code>LocalDate</code> class removes this restriction.
 * <p>
 * Calculations on YearMonthDay are performed using a {@link Chronology}. This
 ...
 * </ul>
 * <p>
 * YearMonthDay is thread-safe and immutable, provided that the Chronology is as
...
public final class YearMonthDay extends BasePartial implements ReadablePartial, Serializable {
	...
	private static final DateTimeFieldType[] FIELD_TYPES = new DateTimeFieldType[] { DateTimeFieldType.year(),
	...
	// -----------------------------------------------------------------------
	/**
	 * Constructs a YearMonthDay from a <code>java.util.Calendar</code> using
	 ...
	 * YearMonthDay with ISO chronology. It is expected that you will only pass
	 * in instances of <code>GregorianCalendar</code> however this is not
	 * validated.
	 *
	 * @param calendar
	...
	public static YearMonthDay fromCalendarFields(Calendar calendar) {
		...
		return new YearMonthDay(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) + 1,
				calendar.get(Calendar.DAY_OF_MONTH));
	}

	/**
	 * Constructs a YearMonthDay from a <code>java.util.Date</code> using
	 * exactly the same field values avoiding any time zone effects.
	 * <p>
	 * Each field is queried from the Date and assigned to the YearMonthDay.
	 * This is useful if you have been using the Date as a local date, ignoring
	 * the zone.
	 * <p>
	...
	/**
	 * Constructs a YearMonthDay with the current date, using the specified
	...
	/**
	 * Constructs a YearMonthDay extracting the partial fields from the
	 ...
	 * {@link ISODateTimeFormat#dateTimeParser()}. Time only strings are now
	 * rejected.
	 *
	 * @param instant
	...
	/**
	 * Constructs a YearMonthDay from an Object that represents a time, using
	...
	/**
	 * Constructs a YearMonthDay with specified time field values using
	 ...
	 */
	// @ requires year >= 0;
	// @ requires monthOfYear >= 1 && monthOfYear <= 12;
	// @ requires dayOfMonth >= 1 && dayOfMonth <= 31;
	...
	/**
	 * Constructs a YearMonthDay with chronology from this instance and new
	 * values.
	 *
	 * @param partial
	...
	/**
	 * Constructs a YearMonthDay with values from this instance and a new
	 * chronology.
	 *
	 * @param partial
	 *            the partial to base this new instance on
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns a copy of this date with the specified chronology. This instance
	 ...
	 * YearMonthDay plus the time zone. The chronology of the time is ignored -
	 * only the field values are used.
	 *
	 * @param time
	 ...
	 * <p>
	 * YearMonthDay is immutable, so there are no set methods. Instead, this
	 * method returns a new instance with the value of year changed.
	 *
	 * @param year
	 *            the year to set
	 ...
	 * <p>
	 * YearMonthDay is immutable, so there are no set methods. Instead, this
	 * method returns a new instance with the value of month of year changed.
	 *
	 * @param monthOfYear
	 ...
	 * <p>
	 * YearMonthDay is immutable, so there are no set methods. Instead, this
	 * method returns a new instance with the value of day of month changed.
	 *
	 * @param dayOfMonth
	...
	// -----------------------------------------------------------------------
	/**
	 * Get the year field property which provides access to advanced
	 * functionality.
	 * 
	 ...
	 * <p>
	 * This class binds a <code>YearMonthDay</code> to a
	...
	public static class Property extends AbstractPartialFieldProperty implements Serializable {
		 ...
		 * <p>
		 * For example, <code>2004-12-20</code> addWrapField one month returns
		 * <code>2004-01-20</code>.
		 * <p>
		 * The YearMonthDay attached to this property is unchanged by this call.
		 * Instead, a new instance is returned.
		 * 
