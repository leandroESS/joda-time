 ...
 * {@link ReadableInterval} interface should be used when different kinds of
 * intervals are to be referenced.
 * <p>
...
public abstract class AbstractInterval implements ReadableInterval {
	 ...
	 * 
	 * @param start
	 *            the start instant in milliseconds
	 * @param end
	 ...
	 *
	 * @param millisInstant
	 *            the instant to compare to, millisecond instant from
	 *            1970-01-01T00:00:00Z
	 * @return true if this time interval contains the millisecond
	 */
	// @ requires millisInstant >= 0
	 ...
	 * wholly contains, starts, finishes or equals it. A zero duration interval
	 ...
	 * <code>contains</code> method is not related to these states. In
	 * particular, a zero duration interval is contained at the start of a
	 * larger interval, but does not overlap (it abuts instead).
	 * <p>
	 * For example:
	 * 
	 * <pre>
	 ...
	 *
	 * @param interval
	 *            the time interval to compare to, null means a zero duration
	 *            interval now
	 ...
	 * <p>
	 * Intervals are inclusive of the start instant and exclusive of the end. An
	 * interval overlaps another if it shares some common part of the datetime
	 * continuum.
	 * <p>
	 * When two intervals are compared the result is one of three states: (a)
	 * they abut, (b) there is a gap between them, (c) they overlap. The abuts
	 * state takes precedence over the other two, thus a zero duration interval
	 * at the start of a larger interval abuts and does not overlap.
	 * <p>
	 * For example:
	 * 
	 * <pre>
	 ...
	 *
	 * @param interval
	 *            the time interval to compare to, null means a zero length
	 *            interval now
	 ...
	 * @return true if the intervals are equal comparing the start and end
	 *         millis
	 * @since 2.3
	 */
	 ...
	 * <p>
	 * This will always return a new <code>MutableInterval</code> with the same
	 * interval.
	 *
	 ...
	 *             if the duration exceeds the capacity of a long
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * Compares this object with the specified object for equality based on
	 * start and end millis plus the chronology. All ReadableInterval instances
	 * are accepted.
	 * <p>
	 * To compare the duration of two time intervals, use {@link #toDuration()}
	 * to get the durations and compare those.
	 *
	 * @param readableInterval
	 *            a readable interval to check against
	 * @return true if the intervals are equal comparing the start millis, end
	 *         millis and chronology
	 */
