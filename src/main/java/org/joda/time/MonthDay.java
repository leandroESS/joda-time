...
/**
 * MonthDay is an immutable partial supporting the monthOfYear and dayOfMonth
 * fields.
 * <p>
 * NOTE: This class only supports the two fields listed above. It is impossible
 * to query any other fields, such as dayOfWeek or centuryOfEra.
 * <p>
 * Calculations on MonthDay are performed using a {@link Chronology}. This
 ...
 * storing the age of the person). This class can be used as the gMonthDay type
 * in XML Schema.
 * <p>
 ...
 * </ul>
 * <p>
 * MonthDay is thread-safe and immutable, provided that the Chronology is as
...
public final class MonthDay extends BasePartial implements ReadablePartial, Serializable {
	 ...
	 * using <code>ISOChronology</code> in the default time zone. The resulting
	...
	/**
	 * Obtains a {@code MonthDay} set to the current system millisecond time
	 * using <code>ISOChronology</code> in the specified time zone. The
	 * resulting object does not use the zone.
	 *
	 * @param zone
	...
	/**
	 * Obtains a {@code MonthDay} set to the current system millisecond time
	 * using the specified chronology. The resulting object does not use the
	 * zone.
	 *
	 * @param chronology
	 ...
	 * <p>
	 * This uses {@link ISODateTimeFormat#localDateParser()} or the format
	 * {@code --MM-dd}.
	 * 
	 * @param str
	 ...
	 */
	@FromString
	public static MonthDay parse(/* @ non_null @ */String str) {
	 ...
	 * @since 2.0
	 */
	public static MonthDay parse(/* @ non_null @ */String str, DateTimeFormatter formatter) {
	...
	// -----------------------------------------------------------------------
	/**
	 * Constructs a MonthDay from a <code>java.util.Calendar</code> using
	 ...
	 * MonthDay with ISO chronology. It is expected that you will only pass in
	 ...
	 * @throws IllegalArgumentException
	 *             if the monthOfYear or dayOfMonth is invalid for the ISO
	 *             chronology
	 */
	...
	/**
	 * Constructs a MonthDay from a <code>java.util.Date</code> using exactly
	...
	// -----------------------------------------------------------------------
	/**
	 * Constructs a MonthDay with the current monthOfYear, using ISOChronology
	 * in the default zone to extract the fields.
	 * <p>
	 * The constructor uses the default time zone, resulting in the local time
	 * being initialised. Once the constructor is complete, all further
	 * calculations are performed without reference to a time-zone (by switching
	 * to UTC).
	 * 
	 * @see #now()
	 */
	 ...
	 * <p>
	 * The constructor uses the specified time zone to obtain the current
	 * month-day. Once the constructor is complete, all further calculations are
	 * performed without reference to a time-zone (by switching to UTC).
	 * 
	 * @param zone
	...
	/**
	 * Constructs a MonthDay with the current month-day, using the specified
	 ...
	 * reference to a time-zone (by switching to UTC).
	 *
	 * @param chronology
	 ...
	 * The constructor uses the time zone of the chronology specified. Once the
	 * constructor is complete, all further calculations are performed without
	 * reference to a time-zone (by switching to UTC). The specified chronology
	...
	/**
	 * Constructs a MonthDay with values from this instance and a new
	 * chronology.
	 *
	 * @param partial
	 *            the partial to base this new instance on
	...
	// -----------------------------------------------------------------------
	/**
	 * Gets the number of fields in this partial, which is two. The supported
	 * fields are MonthOfYear and DayOfMonth. Note that only these fields may be
	 * queried.
	 *
	 ...
	 *
	 * @return the array of field types (cloned), largest to smallest, never
	 *         null
	 */
	...
	/**
	 * Returns a copy of this month-day with the specified field set to a new
	 * value.
	 * <p>
	...
	/**
	 * Returns a copy of this month-day with the value of the specified field
	 * increased.
	 * <p>
	 ...
	 * field is best achieved using methods like {@link #plusMonths(int)}.
	 * 
	 * @param period
	 *            the duration to add to this one, null means zero
	 * @return a copy of this instance with the period added, never null
	 * @throws ArithmeticException
	 *             if the new month-day exceeds the capacity
	 */
	 ...
	 * The month will wrap at the end of the year from December to January. The
	 * day will be adjusted to the last valid value if necessary.
	 * <p>
	 ...
	 * The month will wrap at the end of the year from January to December. The
	 * day will be adjusted to the last valid value if necessary.
	 * <p>
	 * The following three lines are identical in effect:
	 * 
	...
	// -----------------------------------------------------------------------
	/**
	 * Converts this object to a LocalDate with the same month-day and
	 * chronology.
	 *
	 * @param year
	 ...
	 * <p>
	 * MonthDay is immutable, so there are no set methods. Instead, this method
	 ...
	 */
	//@ requires monthOfYear >= 1;
	//@ requires monthOfYear <= 12;
	...
	// -----------------------------------------------------------------------
	/**
	 * Get the month of year field property which provides access to advanced
	 * functionality.
	 * 
	...
	/**
	 * Get the day of month field property which provides access to advanced
	 * functionality.
	 * 
	 ...
	 * <p>
	 * This class binds a <code>YearMonth</code> to a
	...
	public static class Property extends AbstractPartialFieldProperty implements Serializable {
		 ...
		 * <p>
		 * For example, <code>--12-30</code> addWrapField one month returns
		 * <code>--01-30</code>.
		 * <p>
		 * The MonthDay attached to this property is unchanged by this call.
		 * Instead, a new instance is returned.
