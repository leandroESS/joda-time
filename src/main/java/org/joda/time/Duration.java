...
public final class Duration extends BaseDuration implements ReadableDuration, Serializable {
	 ...
	 * be true for most days, however days with Daylight Savings changes will
	 * not have 24 hours, so use this method with care.
	 * <p>
	 ...
	 *             if the days value is too large
	 * @since 1.6
	 */
	// @ requires days >= 0;
	// @ requires days <= 7;
	 ...
	 * <p>
	 * A Duration is a representation of an amount of time. If you want to
	 * express the concept of 'hours' you should consider using the
	 * {@link Hours} class.
	 *
	 * @param hours
	 ...
	 * @return the duration, never null
	 * @throws ArithmeticException
	 *             if the hours value is too large
	 * @since 1.6
	 */
	// @ requires hours >= 0 ;
	 ...
	 * @return the duration, never null
	 * @throws ArithmeticException
	 *             if the minutes value is too large
	 * @since 1.6
	 */
	// @ requires minutes >= 0;
	 ...
	 * @return the duration, never null
	 * @throws ArithmeticException
	 *             if the seconds value is too large
	 * @since 1.6
	 */
	// @ requires seconds >= 0;
	 ...
	 *
	 * @param millis
	 *            the number of standard milliseconds in this duration
	 * @return the duration, never null
	 * @since 2.0
	 */
	// @ requires millis >= 0;
	 ...
	 * chronologies use this definition.
	 * 
	 * @return a period representing the number of standard hours in this
	 *         period, never null
	 * @throws ArithmeticException
	 ...
	 * 
	 * @param divisor
	 *            the divisor to divide this one by
	 * @return the new duration instance
	 */
	//@ requires divisor != 0;
