...
/**
 * Defines the calculation engine for date and time fields. The interface
 * defines a set of methods that manipulate a millisecond datetime with regards
 * to a single field, such as monthOfYear or secondOfMinute.
 * <p>
 * This design is extensible so, if you wish, you can extract a different field
 * from the milliseconds. A number of standard implementations are provided to
 * assist.
 *
 * @author Guy Allard
...
public abstract class DateTimeField {
	 ...
	 * <p>
	 * By convention, names follow a pattern of "dddOfRrr", where "ddd"
	 * represents the (singular) duration unit field name and "Rrr" represents
	 * the (singular) duration range field name. If the range field is not
	 * applicable, then the name of the field is simply the (singular) duration
	 * field name.
	 * 
	 * @return field name
	 */
	 ...
	 *            the milliseconds from 1970-01-01T00:00:00Z to query
	 * @param locale
	 *            the locale to use for selecting a text symbol, null for
	 *            default
	...
	/**
	 * Get the human-readable, text value of this field from the field value. If
	 * the specified locale is null, the default locale is used.
	 *
	 * @param fieldValue
	 *            the numeric value to convert to text
	 * @param locale
	 *            the locale to use for selecting a text symbol, null for
	 *            default
	 * @return the text value of the field
	 ...
	 * instant. If the specified locale is null, the default locale is used.
	 *
	 * @param partial
	 *            the partial instant to query
	 * @param fieldValue
	...
	/**
	 * Get the human-readable, short text value of this field from the field
	...
	/**
	 * Adds a value (which may be negative) to the millis value, overflowing
	 * into larger fields if necessary.
	 * <p>
	 * The value will be added to this field. If the value is too large to be
	 * added solely to this field, larger fields will increase as required.
	 * Smaller fields should be unaffected, except where the result would be an
	 * invalid value for a smaller field. In this case the smaller field is
	 ...
	 * 
	 * @param instant
	 *            the milliseconds from 1970-01-01T00:00:00Z to add to
	 * @param value
	...
	/**
	 * Adds a value (which may be negative) to the partial instant, throwing an
	 * exception if the maximum size of the instant is reached.
	 * <p>
	 * The value will be added to this field, overflowing into larger fields if
	 * necessary. Smaller fields should be unaffected, except where the result
	 * would be an invalid value for a smaller field. In this case the smaller
	 ...
	 * @param values
	 *            the values of the partial instant which should be updated
	 * @param valueToAdd
	 *            the value to add, in the units of the field
	 * @return the passed in values
	 * @throws IllegalArgumentException
	 *             if the value is invalid or the maximum instant is reached
	 */
	//@ requires fieldIndex  >= 0;
	
	public abstract int[] add(ReadablePartial instant, int fieldIndex, /*@ non_null */ int[] values, int valueToAdd);

	/**
	 * Adds a value (which may be negative) to the partial instant, wrapping the
	 * whole partial if the maximum size of the partial is reached.
	 * <p>
	 * The value will be added to this field, overflowing into larger fields if
	 * necessary. Smaller fields should be unaffected, except where the result
	 * would be an invalid value for a smaller field. In this case the smaller
	 ...
	 *            the partial instant
	 * @param fieldIndex
	 *            the index of this field in the partial
	 * @param values
	 *            the values of the partial instant which should be updated
	 * @param valueToAdd
	 *            the value to add, in the units of the field
	...
	/**
	 * Adds a value (which may be negative) to the millis value, wrapping within
	 * this field.
	 * <p>
	 * The value will be added to this field. If the value is too large to be
	 * added solely to this field then it wraps. Larger fields are always
	 * unaffected. Smaller fields should be unaffected, except where the result
	 * would be an invalid value for a smaller field. In this case the smaller
	 * field is adjusted to be in range.
	 * <p>
	 * For example, in the ISO chronology:<br>
	...
	/**
	 * Adds a value (which may be negative) to the partial instant, wrapping
	 * within this field.
	 * <p>
	 * The value will be added to this field. If the value is too large to be
	 * added solely to this field then it wraps. Larger fields are always
	 ...
	 * this field. Any fractional units are dropped from the result. Calling
	 ...
	 *
	 * @param minuendInstant
	 *            the milliseconds from 1970-01-01T00:00:00Z to subtract from
	 * @param subtrahendInstant
	 *            the milliseconds from 1970-01-01T00:00:00Z to subtract off the
	 *            minuend
	 * @return the difference in the units of this field
	 */
	//@ requires minuendInstant >= 0;
	//@ requires subtrahendInstant >= 0;
	...
	/**
	 * Sets a value in the milliseconds supplied, allowing a little leniency at
	 * the margins.
	 * <p>
	 ...
	 * <p>
	 * The value of this field (specified by the index) will be set. If the
	 * value is invalid, an exception if thrown.
	 * <p>
	 * If setting this field would make other fields invalid, then those fields
	 * may be changed. For example if the current date is the 31st January, and
	 * the month is set to February, the day would be invalid. Instead, the day
	 ...
	 * @param instant
	 *            the instant to check for leap status
	 * @return the amount, in units of the leap duration field, that the field
	 *         is leap
	 */
	...
	/**
	 * Get the minimum value for this field using the partial instant and the
	 * specified values.
	 * 
	 * @param instant
	 *            the partial instant to query
	...
	/**
	 * Get the maximum value for this field using the partial instant and the
	 * specified values.
	 * 
	 * @param instant
	 *            the partial instant to query
	 ...
	 * <p>
	 * For example, a datetime of 2002-11-02T23:34:56.789, rounded to the lowest
	 * whole hour is 2002-11-02T23:00:00.000.
	 *
	 * @param instant
	 ...
	 * value is closer to the floor or is exactly halfway, this function behaves
	 * like roundFloor. If the millisecond value is closer to the ceiling, this
	 * function behaves like roundCeiling.
	 *
	 * @param instant
	 *            the milliseconds from 1970-01-01T00:00:00Z to round
	 * @return rounded milliseconds
