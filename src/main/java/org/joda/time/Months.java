 ...
 * <p>
 * <code>Months</code> is an immutable period that can only store months. It
 * does not store years, days or hours for example. As such it is a type-safe
 * way of representing a number of months in an application.
 * <p>
...
public final class Months extends BaseSingleFieldPeriod {
	...
	/**
	 * Constant representing the maximum number of months that can be stored in
	 * this object.
	 */
	public static final Months MAX_VALUE = new Months(Integer.MAX_VALUE);
	/**
	 * Constant representing the minimum number of months that can be stored in
	 * this object.
	 */
	...
	// @ requires months >=0;
	// @ requires months <= 12;
	//@ requires months == Integer.MAX_VALUE;
	//@ requires months == Integer.MIN_VALUE;
	 ...
	 * between the two specified datetimes. This method correctly handles any
	 * daylight savings time changes that may occur during the interval.
	 * <p>
	 * This method calculates by adding months to the start date until the
	 * result is past the end date. As such, a period from the end of a "long"
	 * month to the end of a "short" month is counted as a whole month.
	 *
	 * @param start
	...
	/**
	 * Creates a <code>Months</code> representing the number of whole months in
	 * the specified interval. This method correctly handles any daylight
	...
	/**
	 * Creates a new <code>Months</code> by parsing a string in the ISO8601
	 * format 'PnM'.
	 * <p>
	 * The parse will accept the full ISO syntax of PnYnMnWnDTnHnMnS however
	 * only the months component may be non-zero. If any other component is
	...
	// -----------------------------------------------------------------------
	/**
	 * Creates a new instance representing a number of months. You should
	 * consider using the factory method {@link #months(int)} instead of the
	 * constructor.
	 *
	 * @param months
	 *            the number of months to represent
	 */
	 ...
	 *
	 * @param months
	 *            the amount of months to take away, may be negative, null means
	 *            zero
	 * @return the new period minus the specified number of months
	 * @throws ArithmeticException
	 *             if the result overflows an int
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns a new instance with the months multiplied by the specified
	 * scalar.
	 * <p>
	 * This instance is immutable and unaffected by this method call.
	 *
